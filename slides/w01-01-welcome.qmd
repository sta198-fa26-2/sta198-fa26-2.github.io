...
- For help with **ggplot2**, see <https://ggplot2.tidyverse.org/>.
...
- After Drop/Add, you can miss 4 lectures and still receive full attendance credit;
- We drop the two lowest labs;
- We will give the opportunity for oral exam retakes for partial credit;
