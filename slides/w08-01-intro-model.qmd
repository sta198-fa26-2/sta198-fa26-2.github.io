...
Note our lines do not extrapolate beyond the range of observed data. Extrapolation beyond the range of data observed is quite risky and is generally best avoided, though sometimes the goal is to do so (e.g., weather forecasting, election prediction). If we extend the lines to ultra wealthy individuals, do we believe the lines actually cross, and those in native villages have lower exposures?  
