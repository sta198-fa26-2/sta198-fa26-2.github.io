...
The [prevalence of blood types varies widely around the world](https://en.wikipedia.org/wiki/Blood_type_distribution_by_country). About 36% of the US population has blood type A+ (2nd most common type in US), and we say $P(A+)=0.36$ in the US.
...
::: {.smaller}
Background: [Blanco et al. (2023), *Frontiers in Physiology*](https://doi.org/10.3389/fphys.2023.1251042)
:::
...
- 60 humans and 40 dwarf lemurs
- 30 show insulin resistance
- 18 are humans who show insulin resistance
...
1. Construct a two-way table or Venn diagram.
2. Calculate and interpret $P(\overline{H})$
3. Calculate and interpret $P(H \cap I)$
4. Calculate and interpret $P(H \cup I)$
5. Calculate and interpret $P(\overline{H} \cap I)$
